// AQA GCSE topic data for initial seeding
// This data is inserted into Supabase via the seed script

export const AQA_BOARD = {
  name: "AQA",
  code: "aqa",
  region: "England",
};

export const AQA_SUBJECTS = [
  {
    name: "Mathematics",
    slug: "maths",
    icon: "calculator",
  ...
  },
  {
    ...
    color: "#0d9488",
    topics: [
      { paper: "Paper 1", name: "The Challenge of Natural Hazards", slug: "natural-hazards", specRef: "3.1.1", tier: "both", difficulty: 2, estimatedMinutes: 30, orderIndex: 1 },
      { paper: "Paper 1", name: "Tectonic Hazards", slug: "tectonic-hazards", specRef: "3.1.1.2", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 2 },
      { paper: "Paper 1", name: "Weather Hazards & Climate Change", slug: "weather-hazards-climate-change", specRef: "3.1.1.3-4", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 3 },
      { paper: "Paper 1", name: "Ecosystems & Tropical Rainforests", slug: "ecosystems-rainforests", specRef: "3.1.2", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 4 },
      { paper: "Paper 1", name: "UK Physical Landscapes", slug: "uk-landscapes", specRef: "3.1.3", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 5 },
      { paper: "Paper 2", name: "Urban Issues & Challenges", slug: "urban-issues", specRef: "3.2.1", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 6 },
      { paper: "Paper 2", name: "The Changing Economic World", slug: "changing-economic-world", specRef: "3.2.2", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 7 },
      { paper: "Paper 2", name: "Resource Management", slug: "resource-management", specRef: "3.2.3", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 8 },
    ],
  },
  {
    name: "History",
    ...
    color: "#e11d48",
    topics: [
      { paper: "Paper 1: Germany", name: "Kaiser Germany & the Weimar Republic", slug: "germany-kaiser-weimar", specRef: "1B/A", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 1 },
      { paper: "Paper 1: Germany", name: "The Rise of Hitler and the Nazis", slug: "nazi-rise", specRef: "1B/A", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 2 },
      { paper: "Paper 1: Germany", name: "Nazi Control and Life in Germany", slug: "nazi-control-life", specRef: "1B/A", tier: "both", difficulty: 3, estimatedMinutes: 40, orderIndex: 3 },
      { paper: "Paper 1: Conflict", name: "Peacemaking after the First World War", slug: "conflict-peacemaking", specRef: "1B/B", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 4 },
      { paper: "Paper 1: Conflict", name: "The League of Nations and International Peace", slug: "conflict-league", specRef: "1B/B", tier: "both", difficulty: 3, estimatedMinutes: 35, orderIndex: 5 },
      { paper: "Paper 1: Conflict", name: "The Origins of the Second World War", slug: "conflict-origins-war", specRef: "1B/B", tier: "both", difficulty: 4, estimatedMinutes: 40, orderIndex: 6 },
      { paper: "Paper 2: Health", name: "Britain: Health and the People", slug: "health-people", specRef: "2A/A", tier: "both", difficulty: 4, estimatedMinutes: 45, orderIndex: 7 },
      { paper: "Paper 2: Elizabeth", name: "Elizabethan England, c1568–1603", slug: "elizabethan-england", specRef: "2B/C", tier: "both", difficulty: 4, estimatedMinutes: 45, orderIndex: 8 },
    ],
  },
  {
